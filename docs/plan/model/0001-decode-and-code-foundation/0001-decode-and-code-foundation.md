...
**O que continua sem prova, e é honesto listar:** o ramo `path_glob_match` do instrumento, que exige
uma rule **com** `paths:` — a primeira nasce na Fase 3; o `PostCompact` numa compactação real, que
não se força; e se o modelo **obedece** aos princípios depois de carregá-los, que é a `L-01` e nenhum
campo transforma em oráculo.
